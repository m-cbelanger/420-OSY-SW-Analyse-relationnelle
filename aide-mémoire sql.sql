...
-- r�cup�ration id automatique (cr�ation du dernier id avec IDENTITY)
declare @id int;
...
-- Trigger apr�s insertion (doit �tre le premier script du batch (apr�s un GO))
